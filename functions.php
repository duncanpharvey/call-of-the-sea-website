...
function theme_enqueue_scripts() {
	...
	if ( is_page( 14232 ) ) { wp_enqueue_script( 'custom-payment-success', get_stylesheet_directory_uri() . '/js/custom-payment-success.js', array(), '2.0.0', true); }
    
    // https://callofthesea.org/sail-with-us/youth-day/
	if ( is_page( 11514 ) ) { wp_enqueue_script( 'custom-anchor-scrolling', get_stylesheet_directory_uri() . '/js/custom-anchor-scrolling.js', array(), '2.0.0', true); }
...
add_filter( 'web_app_manifest', function( $manifest ) {
	...
	$manifest['icons'] = [["src" => "/wp-content/uploads/2020/06/call-of-the-sea-logo-512px.png", "sizes" => "512x512"],
