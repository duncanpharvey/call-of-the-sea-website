...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	...
	<dl>
		...
		if ($eventbrite_id) : ?>
			<dd>
				<a class="fusion-button button-flat fusion-button-default-size button-default fusion-button-default-span fusion-button-default-type eventbrite-checkout-button" target="_self" id="eventbrite-widget-modal-trigger-1" eventbriteid="<?php echo $eventbrite_id; ?>">
		...
		if (!empty($url)) : ?>
			...
			<dd class="tribe-events-event-url">
				<a class="fusion-button button-flat fusion-button-default-size button-default fusion-button-default-span fusion-button-default-type event-details-button" target="_blank" rel="noopener noreferrer" href="<?php echo $url; ?>">
					<span class="fusion-button-text">Click here for additional event information</span>
				</a>
			</dd>
		<?php endif ?>
